...
for k=100:100:1000 x=0.01:1:100 t=log(2*pi*k)-log(x) y=exp(t) loglog(x,y,‘k’),grid on hold on
...
text(80,10,‘100’) text(20,1,‘sd in cm’) xlabel(‘ period in sec’) ylabel(‘ sv in cm/sec’) text(0.01,200,‘100’) text(0.01,20,‘10’) text(0.01,2,‘1’) text(0.02,0.4,‘0.1’) text(0.07,0.1,‘0.01’) text(.02,0.8,’sa/g’) gtext(‘ no damping’) gtext(‘ damping=2%’) gtext(‘ damping=5%’) gtext(‘ damping=10%’) gtext(‘ damping=20%’)